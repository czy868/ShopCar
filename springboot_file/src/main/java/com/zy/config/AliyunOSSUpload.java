...
import com.zy.serviceimpl.FileUploadMultiServiceImpl;
...
public class AliyunOSSUpload implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            UploadPartResult uploadPartResult = FileUploadMultiServiceImpl.client.uploadPart(uploadPartRequest);
    ...
    public static String claimUploadId(String bucketName, String key) {
        ...
        InitiateMultipartUploadResult result = FileUploadMultiServiceImpl.client.initiateMultipartUpload(request);
    ...
    public static void completeMultipartUpload(String uploadId) {
        ...
        // 完成分块上传
        FileUploadMultiServiceImpl.client.completeMultipartUpload(completeMultipartUploadRequest);
    }
    ...
    public static void listAllParts(String uploadId) {
        ...
        // 获取上传的所有分块信息
        PartListing partListing = FileUploadMultiServiceImpl.client.listParts(listPartsRequest);
